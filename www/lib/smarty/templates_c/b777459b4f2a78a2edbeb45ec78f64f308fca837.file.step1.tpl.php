<?php /* Smarty version Smarty-3.0.6, created on 2013-01-20 00:42:08
         compiled from "/data/newznab/www/views/templates/install/step1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44629465550fb3d60442437-70178218%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b777459b4f2a78a2edbeb45ec78f64f308fca837' => 
    array (
      0 => '/data/newznab/www/views/templates/install/step1.tpl',
      1 => 1299902254,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44629465550fb3d60442437-70178218',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_truncate')) include '/data/newznab/www/lib/smarty/plugins/modifier.truncate.php';
...
/schema.sql</span><?php }?></td>
	...
	<tr class="alt">
		<td>Checking PHP's version:<?php if (!$_smarty_tpl->getVariable('cfg')->value->phpCheck){?><br /><span class="warn">Your PHP verion is lower than recommened (5.2.0). You may encounter errors if you proceed.</span><?php }?></td>
	...
	<tr class="">
		<td>Checking PHP's memory_limit:<?php if (!$_smarty_tpl->getVariable('cfg')->value->memlimitCheck){?><br /><span class="warn">Your PHP installation's memory_limit setting is low, please consider increasing it >= 256MB</span><?php }?></td>
